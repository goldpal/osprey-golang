...
![Logo](https://github.com/goldpal/osprey-golang/blob/main/images/osprey-logo.png)
...
![Screenshot](https://github.com/goldpal/osprey-golang/blob/main/images/tn.png)
...
```console
cd themes
git clone https://github.com/goldpal/osprey-golang.git
```
...
This theme is released under the GNU 3.0 license. For more information read the [license](https://github.com/goldpal/osprey-golang/blob/main/LICENSE).
